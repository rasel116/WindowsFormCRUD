...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeeRow AddEmployeeRow(string EName, string Gender, string Religion, System.DateTime DOB) {
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_EName = 1 AND [EName] IS NULL) OR ([EName] = @Original_EName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Religion = 1 AND [Religion] IS NULL) OR ([Religion] = @Original_Religion)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EName], [Gender], [Religion], [DOB]) VALUES (@ENam" +
                "e, @Gender, @Religion, @DOB);\r\nSELECT EmployeeID, EName, Gender, Religion, DOB F" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EName] = @EName, [Gender] = @Gender, [Religion] = @Religion, [DOB] = @DOB WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_EName = 1 AND [EName] IS NULL) OR ([EName] = @Original_EName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Religion = 1 AND [Religion] IS NULL) OR ([Religion] = @Original_Religion)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)));
SELECT EmployeeID, EName, Gender, Religion, DOB FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, EName, Gender, Religion, DOB FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_EName, string Original_Gender, string Original_Religion, global::System.Nullable<global::System.DateTime> Original_DOB) {
        ...
        public virtual int Insert(string EName, string Gender, string Religion, global::System.Nullable<global::System.DateTime> DOB) {
            if ((EName == null)) {
        ...
        public virtual int Update(string EName, string Gender, string Religion, global::System.Nullable<global::System.DateTime> DOB, int Original_EmployeeID, string Original_EName, string Original_Gender, string Original_Religion, global::System.Nullable<global::System.DateTime> Original_DOB, int EmployeeID) {
            if ((EName == null)) {
            ...
            if ((Original_Religion == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Religion));
            }
            if ((Original_DOB.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EName, string Gender, string Religion, global::System.Nullable<global::System.DateTime> DOB, int Original_EmployeeID, string Original_EName, string Original_Gender, string Original_Religion, global::System.Nullable<global::System.DateTime> Original_DOB) {
            return this.Update(EName, Gender, Religion, DOB, Original_EmployeeID, Original_EName, Original_Gender, Original_Religion, Original_DOB, Original_EmployeeID);
        }
    }
